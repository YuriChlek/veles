...
export interface CustomerSettingsLinkProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
    adminName?: string;
}

const CustomerSettingsLink = React.forwardRef<HTMLAnchorElement, CustomerSettingsLinkProps>(({ adminName }, ref) => {
    return (
